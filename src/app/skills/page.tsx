        ...
        >
          ...
          <div className='relative max-w-7xl mx-auto text-center'>
            ...
            <motion.p
              ...
              variants={contentVariants}
            >
              A comprehensive display of my technical expertise across
              cybersecurity and development domains, showcasing proficiency
              levels and real-world experience with industry-standard tools and
              technologies.
            </motion.p>
        ...
        >
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <motion.p
              ...
              variants={contentVariants}
            >
              With my comprehensive skill set in cybersecurity and development,
              I can help protect your organization from evolving threats while
