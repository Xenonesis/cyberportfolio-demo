import { generateSeoMetadata, generateOpenGraph, generateTwitterCard, getOrganizationJsonLd, getWebsiteJsonLd } from '@/lib/schema';
...
export const SEO = ({ title, description, keywords, image, url, type }: SEOProps) => {
  ...
  return (
    <>
      ...
      <meta name="keywords" content={keywords?.join(', ') || SEO_CONFIG.keywords.join(', ')} />
