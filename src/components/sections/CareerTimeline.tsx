...
export const CareerTimeline = ({ className = '' }: CareerTimelineProps) => {
  ...
  const getEventIcon = (event: TimelineEvent) => {
    const baseColor =
      event.color === 'neon-green' ? 'neon-green' : ('cyan' as const);

    switch (event.icon) {
      case 'graduation-cap':
        return (
          <LockIcon size='lg' variant='default' color={baseColor} animate />
        );
      case 'shield':
        return (
          <ShieldIcon size='lg' variant='default' color={baseColor} animate />
        );
      case 'alert-circle':
        return (
          <LockIcon size='lg' variant='unlocked' color={baseColor} animate />
        );
      case 'code':
        return (
          <CircuitPattern
      ...
      case 'certificate':
        return (
          <ShieldIcon size='lg' variant='active' color={baseColor} animate />
        );
      case 'target':
        return (
          <LockIcon size='lg' variant='locked' color={baseColor} animate />
        );
      case 'search':
        return (
          <ShieldIcon size='lg' variant='default' color={baseColor} animate />
  ...
  return (
    <section
      className={`py-20 bg-deep-navy-900 ${className}`}
      id='career-timeline'
    >
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <h2 className='text-4xl md:text-5xl font-bold text-white mb-6'>
            Career <span className='text-cyan-400'>Timeline</span> & Resume
            Summary
          </h2>
          <p className='text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
            Explore my professional journey through cybersecurity and
            development, showcasing education, experience, certifications, and
            key achievements that demonstrate expertise in protecting digital
            assets.
          </p>
        </motion.div>
              ...
              <div>
                ...
                <div className='mb-6'>
                  ...
                  <ul className='space-y-2'>
                    {RESUME_SUMMARY.keyAchievements.map(
                      (achievement, index) => (
                ...
                {/* Specializations */}
                <div className='mb-6'>
                  <h4 className='text-lg font-medium text-neon-green-400 mb-3'>
                    Specializations
                  </h4>
                  <div className='flex flex-wrap gap-2'>
                    {RESUME_SUMMARY.specializations.map(
              ...
              <div className='space-y-6'>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='text-center p-4 bg-navy-700 rounded-lg border border-neon-green-500/30'>
                    <div className='text-2xl font-bold text-neon-green-500 mb-1'>
                      100+
                    </div>
          ...
          <div className='space-y-8'>
            {filteredEvents.map((event, index) => (
              ...
              >
                ...
                {/* Event Content */}
                <div
                  className={`lg:w-5/12 ${index % 2 === 0 ? 'lg:pr-8 lg:ml-auto' : 'lg:pl-8 lg:mr-auto'}`}
                >
                  <div className='bg-navy-800 border border-navy-700 rounded-lg p-6 hover:border-cyan-500 transition-all duration-300 group'>
                    ...
                    <div className='flex items-start justify-between mb-4'>
                      ...
                      <div className='lg:hidden'>{getEventIcon(event)}</div>
                    </div>
                            ...
                            >
                              ...
                              {event.technologies &&
                                event.technologies.length > 0 && (
                                  <>
                                    <h5 className='text-sm font-medium text-gray-300 mt-3'>
                                      Technologies:
                                    </h5>
                                    <div className='flex flex-wrap gap-2'>
