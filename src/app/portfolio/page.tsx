...
export const metadata: Metadata = {
  ...
  description:
    'View my cybersecurity portfolio showcasing successful security implementations, enterprise overhauls, cloud migrations, and penetration testing projects.',
  keywords: [
    ...SEO_CONFIG.keywords,
    'portfolio',
    'case studies',
        ...
        >
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              >
                Cybersecurity{' '}
                <span className='text-neon-green-400'>Portfolio</span>
              </h1>
              <p className='text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                Explore successful cybersecurity implementations that have
                protected organizations, prevented data breaches, and
                established robust security frameworks across various
                industries.
              </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <header className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                A curated selection of successful cybersecurity implementations
                showcasing my expertise in enterprise security, cloud migration,
        ...
        >
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <header className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Hear from industry leaders and executives who have benefited
                from my cybersecurity expertise and successful project
                implementations.
              </p>
            </header>
            ...
            <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-3'>
              ...
              >
                ...
                <p className='text-gray-300 mb-4 leading-relaxed'>
                  "Aditya's enterprise security overhaul transformed our entire
                  security posture. The 75% reduction in security incidents and
                  successful SOC 2 compliance achievement exceeded our
                  expectations. His expertise in Zero Trust architecture is
                  truly exceptional."
                </p>
                ...
                <div className='mt-3'>
                  <span className='text-xs text-gray-500'>
                    Enterprise Security Overhaul Project
                  </span>
                </div>
              </blockquote>
              ...
              >
                ...
                <p className='text-gray-300 mb-4 leading-relaxed'>
                  "The cloud migration security project was critical for our
                  HIPAA compliance. Aditya's deep understanding of AWS security
                  and patient data protection ensured a seamless transition with
                  zero data breaches. His attention to detail and strategic
                ...
                <div className='mt-3'>
                  <span className='text-xs text-gray-500'>
                    Cloud Migration Security Project
                  </span>
                </div>
              </blockquote>
              ...
              >
                ...
                <p className='text-gray-300 mb-4 leading-relaxed'>
                  ...
                  vulnerabilities that could have cost us millions. His
                  comprehensive report and 90-day remediation plan provided
                  clear actionable steps. The board was impressed with his
        ...
        >
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <header className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Quantifiable improvements and security enhancements achieved
                through my cybersecurity implementations across various
            ...
            <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-4'>
              ...
              <div className='bg-navy-800 border border-navy-700 rounded-lg p-6 text-center'>
                <div className='text-4xl font-bold text-neon-green-400 mb-2'>
                  50%
                </div>
            ...
            <div className='bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8 md:p-12 text-center'>
              <header className='mb-8'>
                ...
                <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
                  Let's discuss how I can help implement comprehensive
                  cybersecurity solutions that protect your organization and
                  deliver measurable results like those showcased here.
                </p>
              </header>
