...
export const metadata: Metadata = {
  title:
    'About Aditya Kumar Tiwari - Cybersecurity Specialist & Full-Stack Developer',
  description:
    "Bridging Security and Innovation. Learn about Aditya Kumar Tiwari's dual expertise in cybersecurity and full-stack development, certifications, and proven track record in protecting digital assets.",
  keywords: [
    ...SEO_CONFIG.keywords,
    'about',
  ...
  twitter: {
    ...
    title:
      'About Aditya Kumar Tiwari - Cybersecurity Specialist & Full-Stack Developer',
    description:
      'Bridging Security and Innovation. Learn about dual expertise in cybersecurity and development with 1+ years of professional experience.',
