...
export const TestimonialClientLogos: React.FC<TestimonialClientLogosProps> = ({ clients }) => {
  if (clients.length === 0) {
    return null;
  }
    ...
    >
        ...
        {clients.length > 8 && (
          ...
          >
            <div className="w-16 h-16 bg-deep-navy-700 border-2 border-dashed border-electric-cyan-500 rounded-lg flex items-center justify-center">
              <span className="text-electric-cyan-400 font-bold text-lg">+</span>
            </div>
            <div className="text-center">
              <p className="text-electric-cyan-400 font-medium text-sm">And more</p>
      ...
      >
        <div className="flex items-center space-x-2 text-gray-400">
          <svg className="w-4 h-4 text-electric-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
