...
export const metadata: Metadata = {
  ...
  description: "Comprehensive cybersecurity services including security assessment, incident response, cloud security, compliance, and security training. Expert protection for your organization.",
  keywords: [...SEO_CONFIG.keywords, "services", "security assessment", "incident response", "cloud security", "compliance", "security training"],
  openGraph: {
    title: "Cybersecurity Services - Aditya Kumar Tiwari",
    description: "Comprehensive cybersecurity services including security assessment, incident response, cloud security, compliance, and security training. Expert protection for your organization.",
    images: [
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                From vulnerability assessment to incident response, I provide end-to-end cybersecurity 
                solutions tailored to your organization's specific needs, compliance requirements, 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive security assessments and protection services designed to identify 
                vulnerabilities, prevent attacks, and ensure your organization's digital safety.
              </p>
            </header>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {SERVICES.filter(service => 
                ['security-assessment', 'incident-response', 'cloud-security'].includes(service.id)
              ).map((service) => (
                <article 
                  key={service.id}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <h2 
                ...
                className="text-4xl md:text-5xl font-bold text-white mb-6"
              >
                Strategic <span className="text-neon-green-400">Consulting Services</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Expert guidance and strategic planning to help your organization build robust 
                security frameworks, achieve compliance, and develop comprehensive security programs.
              </p>
            </header>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {SERVICES.filter(service => 
                ['security-consulting', 'compliance', 'security-training'].includes(service.id)
              ).map((service) => (
                <article 
                  key={service.id}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <h2 
                ...
                className="text-4xl md:text-5xl font-bold text-white mb-6"
              >
                Security <span className="text-cyan-400">Credentials & Badges</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                My services are backed by industry-recognized certifications, proven methodologies, 
                and a track record of successful implementations across various industries.
              </p>
            </header>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="bg-navy-800 border border-navy-700 rounded-lg p-6 text-center">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Implement comprehensive Zero Trust frameworks that verify every access request 
              ...
              <div className="bg-navy-800 border border-navy-700 rounded-lg p-6 text-center">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Achieve and maintain SOC 2 Type II compliance with comprehensive audit support.
                </p>
              </div>
              ...
              <div className="bg-navy-800 border border-navy-700 rounded-lg p-6 text-center">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Rapid response to security incidents with forensic analysis and containment.
                </p>
              </div>
              ...
              <div className="bg-navy-800 border border-navy-700 rounded-lg p-6 text-center">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Secure your cloud infrastructure with proper configuration and continuous monitoring.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8 md:p-12 text-center">
              <header className="mb-8">
                ...
                <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                  Choose the right cybersecurity service for your organization's needs and let me 
                  help you implement comprehensive security solutions that protect against evolving threats.
                </p>
              </header>
