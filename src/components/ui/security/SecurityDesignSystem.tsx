...
export const SecurityDesignSystemProvider = ({
  ...
  return (
    <SecurityContext.Provider value={contextValue}>
      <div
        className={`security-design-system theme-${theme} security-${securityLevel}`}
      >
        {children}
      </div>
...
export const SecurityDashboard = ({
  ...
  if (!context) {
    throw new Error(
      'SecurityDashboard must be used within SecurityDesignSystemProvider'
    );
  }
  ...
  return (
    <div
      className={`security-dashboard p-6 rounded-lg border ${className}`}
      style={{
...
export const SecurityAlert = ({
  ...
  if (!context) {
    throw new Error(
      'SecurityAlert must be used within SecurityDesignSystemProvider'
    );
  }
...
export const useSecurityContext = () => {
  ...
  if (!context) {
    throw new Error(
      'useSecurityContext must be used within SecurityDesignSystemProvider'
    );
  }
