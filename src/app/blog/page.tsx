...
export const metadata: Metadata = {
  ...
  description:
    'Expert insights and articles on cybersecurity, Zero Trust architecture, cloud security, incident response, and compliance. Stay updated with the latest security trends and best practices.',
  keywords: [
    ...SEO_CONFIG.keywords,
    'blog',
