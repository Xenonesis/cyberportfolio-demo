              ...
              <div className='relative h-64 bg-gradient-to-r from-cyan-600 to-neon-green-600'>
                ...
                <div className='absolute inset-0 p-6 flex items-end'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-sm font-medium ${getDifficultyColor(caseStudy.difficultyLevel)}`}
                    >
              ...
              <div className='p-8'>
                ...
                <div className='flex flex-wrap items-center justify-between mb-6 gap-4'>
                  ...
                  <div className='text-right'>
                    ...
                    <p className='text-gray-500 text-sm'>
                      {new Date(
                        caseStudy.timeline.startDate
                      ).toLocaleDateString()}{' '}
                      -{' '}
                      {new Date(
                        caseStudy.timeline.endDate
                      ).toLocaleDateString()}
                    </p>
                  </div>
                </div>
                        ...
                        >
                          <div className='flex items-center justify-between'>
                            ...
                            <div className='flex items-center space-x-2'>
                              <span
                                className={`font-semibold ${metric.isPositive ? 'text-neon-green-400' : 'text-red-400'}`}
                              >
                                {metric.improvement}
                              </span>
                              {metric.icon && (
