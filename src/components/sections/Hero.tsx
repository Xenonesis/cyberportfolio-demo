    ...
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-deep-navy-900'>
      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          >
            Cybersecurity Specialist & Full-Stack Developer combining security
            expertise with cutting-edge development to create innovative, secure
          ...
          >
            Protecting digital assets with comprehensive security assessments,
            secure development practices, and AI/ML-powered threat detection.
            Trusted by startups, SMBs, and tech companies worldwide.
          </motion.p>
          ...
          >
            ...
            >
              <div className='text-3xl font-bold text-electric-cyan-400 mb-2'>
                1+
              </div>
            ...
            >
              <div className='text-3xl font-bold text-neon-green-500 mb-2'>
                100+
              </div>
              <div className='text-gray-400 text-sm'>
