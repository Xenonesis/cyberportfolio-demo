...
import { CASE_STUDIES, CASE_STUDIES_CONFIG, CASE_STUDY_FILTERS } from '@/lib/caseStudiesData';
...
export const CaseStudiesSection: React.FC<CaseStudiesSectionProps> = ({ 
    ...
    filtered.sort((a, b) => {
      switch (filters.sortBy) {
        ...
        case 'client-size':
          ...
          return (sizeOrder[b.projectSize as keyof typeof sizeOrder] || 1) - (sizeOrder[a.projectSize as keyof typeof sizeOrder] || 1);
        default:
          return 0;
      }
    });
  ...
  const totalPages = Math.ceil(filteredCaseStudies.length / config.itemsPerPage);

  // Handle filter changes
  const handleFilterChange = (filterType: keyof CaseStudyFilters, value: string | string[]) => {
    setFilters(prev => ({
      ...prev,
      [filterType]: value,
    }));
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Case Studies & <span className="text-neon-green-400">Security Projects</span>
          </h2>
        ...
        {filteredCaseStudies.length === 0 && (
          ...
          >
            ...
            <h3 className="text-lg font-semibold text-white mb-2">No Case Studies Found</h3>
