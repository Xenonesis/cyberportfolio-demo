...
export const CaseStudiesSEO: React.FC<CaseStudiesSEOProps> = ({
  ...
  const generateCaseStudiesSchema = (): string => {
    const schema = {
      ...
      'description': 'Comprehensive collection of cybersecurity case studies showcasing measurable security improvements and successful implementations.',
      ...
      'itemListElement': caseStudies.map((caseStudy, index) => ({
        ...
        'item': {
          ...
          'mainEntity': {
            ...
            'outcome': caseStudy.results.map(result => `${result.title}: ${result.value} ${result.unit}`),
          },
          'offers': {
            '@type': 'Offer',
  ...
  const generateServiceSchema = (): string => {
    const schema = {
      ...
      'description': 'Professional cybersecurity services including security assessments, incident response, cloud security, and secure development.',
      'provider': {
        '@type': 'Person',
        'name': 'Aditya Kumar Tiwari',
        'url': 'https://aditya-cybersecurity.com',
  ...
  return (
    <>
      ...
      {/* Meta Tags */}
      <meta name="description" content={`Explore ${caseStudies.length} cybersecurity case studies showcasing measurable security improvements, successful implementations, and proven results across various industries.`} />
      <meta name="keywords" content="cybersecurity case studies, security projects, security assessment, penetration testing, incident response, cloud security, security metrics, security improvements" />
      
      {/* Open Graph */}
      <meta property="og:title" content="Case Studies & Security Projects - Aditya Kumar Tiwari" />
      <meta property="og:description" content={`View ${caseStudies.length} successful cybersecurity implementations with measurable outcomes and proven security improvements.`} />
      <meta property="og:type" content="website" />
      <meta property="og:url" content="https://aditya-cybersecurity.com/case-studies" />
      <meta property="og:image" content="https://aditya-cybersecurity.com/images/og-case-studies.jpg" />
      
      {/* Twitter Card */}
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Case Studies & Security Projects - Aditya Kumar Tiwari" />
      <meta name="twitter:description" content={`View ${caseStudies.length} successful cybersecurity implementations with measurable outcomes.`} />
      <meta name="twitter:image" content="https://aditya-cybersecurity.com/images/og-case-studies.jpg" />
