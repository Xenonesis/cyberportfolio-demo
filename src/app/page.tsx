        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              >
                Comprehensive <span className="text-cyan-400">Security Services</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                From vulnerability assessment to incident response, I provide end-to-end cybersecurity solutions 
                tailored to your organization's specific needs and compliance requirements.
              </p>
            </header>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                  Comprehensive evaluation of your organization's security posture including vulnerability scanning, 
                ...
                <ul className="text-gray-400 text-sm space-y-1 mb-4">
                  ...
                  <li className="flex items-start space-x-2">
                    <div className="w-1 h-1 bg-cyan-400 rounded-full mt-2 flex-shrink-0" />
                    <span>Detailed findings report with remediation guidance</span>
                  </li>
                </ul>
                <footer>
                  <a 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <h2 
                ...
                className="text-4xl md:text-5xl font-bold text-white mb-6"
              >
                Proven <span className="text-neon-green-400">Security Results</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Explore successful cybersecurity implementations that have protected organizations 
                and prevented potential breaches.
              </p>
            </header>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                    Led a comprehensive security transformation implementing Zero Trust architecture 
                    and reducing security incidents by 75%.
                  </p>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                    Designed and implemented security controls ensuring HIPAA compliance and patient 
                    data protection during AWS migration.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="px-2 py-1 bg-cyan-600/20 text-cyan-400 text-xs rounded">
                      Cloud Security
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-400 text-sm mb-4 leading-relaxed">
                    Conducted extensive penetration testing identifying critical vulnerabilities and 
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Hear from executives and security professionals who have benefited from my cybersecurity expertise.
              </p>
            </header>
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-gray-300 mb-4 leading-relaxed">
                  "Aditya transformed our security posture completely. His expertise in Zero Trust architecture 
                  and incident response saved our company from potential catastrophic breaches. The 75% reduction 
                  in security incidents speaks volumes about his capabilities."
                </p>
              ...
              >
                ...
                <p className="text-gray-300 mb-4 leading-relaxed">
                  "Working with Aditya on our cloud migration was exceptional. His deep understanding of HIPAA 
                  compliance and AWS security ensured our patient data remained protected throughout the transition. 
                  His strategic approach and attention to detail are unmatched."
                </p>
                <div className="flex space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <svg 
              ...
              >
                ...
                <p className="text-gray-300 mb-4 leading-relaxed">
                  "Aditya's penetration testing revealed critical vulnerabilities we never knew existed. His 
                  comprehensive report and remediation guidance have significantly strengthened our security 
                  program. His professionalism and expertise are top-notch."
                </p>
                <div className="flex space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <svg 
            ...
            <div className="bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8 md:p-12 text-center">
              <header className="mb-8">
                ...
                <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                  Let's discuss how I can help protect your digital assets and implement comprehensive 
