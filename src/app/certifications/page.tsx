...
const CERTIFICATIONS = [
  {
    ...
    description: 'CISSP is the premier certification for experienced security practitioners, managers, and executives interested in proving their knowledge across a wide array of security practices.',
    verificationUrl: 'https://www.isc2.org/credentials/CISSP',
    skills: ['Security and Risk Management', 'Asset Security', 'Security Architecture', 'Communication and Network Security', 'Identity and Access Management', 'Security Assessment', 'Security Operations', 'Software Development Security'],
    status: 'active'
  },
  {
    id: 'cisa',
    ...
    description: 'CISA is globally recognized as the standard of achievement for IS audit, control, and security professionals.',
    verificationUrl: 'https://www.isaca.org/credentialing/cisa',
    skills: ['Information System Auditing Process', 'Governance and Management', 'Information Systems Acquisition', 'Operations and Business Resilience', 'Protection of Information Assets'],
    status: 'active'
  },
  {
    id: 'ceh',
    ...
    description: 'CEH provides an advanced understanding of ethical hacking, penetration testing, and security assessment methodologies.',
    verificationUrl: 'https://www.eccouncil.org/programs/certified-ethical-hacker-ceh/',
    skills: ['Ethical Hacking Fundamentals', 'Footprinting and Reconnaissance', 'Scanning Networks', 'Enumeration', 'Vulnerability Analysis', 'System Hacking', 'Malware Threats', 'Social Engineering'],
    status: 'active'
  },
  {
    ...
    description: 'Validates expertise in securing AWS workloads and services, including data protection, access control, and incident response.',
    verificationUrl: 'https://aws.amazon.com/certification/certified-security-specialty/',
    skills: ['Data Protection', 'Infrastructure Security', 'Incident Response', 'Identity and Access Management', 'Logging and Monitoring', 'Security Automation'],
    status: 'active'
  },
  {
    ...
    description: 'Validates skills in implementing security controls and threat protection, managing identity and access, and protecting data, applications, and networks in Azure.',
    verificationUrl: 'https://learn.microsoft.com/en-us/certifications/azure-security-engineer/',
    skills: ['Identity and Access Management', 'Platform Protection', 'Security Operations', 'Data and Applications Protection'],
    status: 'active'
  },
  {
    ...
    description: 'Demonstrates ability to design, implement, and manage security solutions on Google Cloud Platform.',
    verificationUrl: 'https://cloud.google.com/certification/cloud-security-engineer',
    skills: ['Security Planning', 'Threat Protection', 'Data Protection', 'Incident Response', 'Identity Management', 'Network Security'],
    status: 'active'
  }
];
...
const TRAINING_HISTORY = [
  {
    ...
    date: '2023-11-15',
    duration: '40 hours',
    description: 'Comprehensive training on Zero Trust principles, implementation strategies, and practical deployment techniques.',
    skills: ['Zero Trust Architecture', 'Identity Verification', 'Micro-segmentation', 'Continuous Monitoring']
  },
  {
    ...
    date: '2023-08-20',
    duration: '32 hours',
    description: 'Advanced techniques for incident detection, analysis, containment, and recovery in modern enterprise environments.',
    skills: ['Incident Detection', 'Forensic Analysis', 'Threat Hunting', 'Recovery Strategies']
  },
  {
    ...
    date: '2023-05-10',
    duration: '24 hours',
    description: 'Designing and implementing secure cloud architectures across multiple cloud providers.',
    skills: ['Cloud Architecture', 'Security Design', 'Multi-cloud Security', 'Compliance Frameworks']
  },
  {
    ...
    date: '2023-02-15',
    duration: '28 hours',
    description: 'Understanding threat actors, attack patterns, and implementing proactive defense strategies.',
    skills: ['Threat Analysis', 'Intelligence Gathering', 'Risk Assessment', 'Proactive Defense']
  }
];

export const metadata: Metadata = {
  title: "Certifications - Aditya Kumar Tiwari",
  description: "View Aditya Kumar Tiwari's cybersecurity certifications including CISSP, CISA, CEH, AWS Security Specialty, and other industry-recognized credentials.",
  keywords: [...SEO_CONFIG.keywords, "certifications", "CISSP", "CISA", "CEH", "AWS Security", "Azure Security", "Google Cloud Security", "professional credentials"],
  openGraph: {
    title: "Certifications - Aditya Kumar Tiwari",
    description: "View Aditya Kumar Tiwari's cybersecurity certifications including CISSP, CISA, CEH, AWS Security Specialty, and other industry-recognized credentials.",
    images: [
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Industry-recognized cybersecurity certifications and credentials that validate 
                my expertise in security architecture, incident response, cloud security, and 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Active certifications that demonstrate my commitment to maintaining the highest 
                standards of cybersecurity expertise and staying current with industry best practices.
              </p>
            </header>
                ...
                >
                  ...
                  <div className="mb-4">
                    <div className="flex items-center justify-between text-sm text-gray-400 mb-1">
                      <span>Issued:</span>
                      <span>{new Date(cert.issuedDate).toLocaleDateString('en-US', { 
                        year: 'numeric', 
                        month: 'long', 
                        day: 'numeric' 
                      })}</span>
                    ...
                    <div className="flex items-center justify-between text-sm text-gray-400 mb-1">
                      <span>Expires:</span>
                      <span className="text-red-400">{new Date(cert.expirationDate).toLocaleDateString('en-US', { 
                        year: 'numeric', 
                        month: 'long', 
                        day: 'numeric' 
                      })}</span>
                  ...
                  <div className="flex items-center justify-between text-sm mb-4">
                    <span className={`px-2 py-1 rounded text-xs font-medium ${
                      cert.status === 'active' ? 'bg-green-600/20 text-green-400' : 'bg-red-600/20 text-red-400'
                    }`}>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <h2 
                ...
                className="text-4xl md:text-5xl font-bold text-white mb-6"
              >
                Credential <span className="text-neon-green-400">Verification</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                All certifications can be independently verified through the issuing organizations. 
                This ensures transparency and validates my professional credentials.
              </p>
            </header>
            
            {/* Verification Links */}
            <div className="bg-navy-700 border border-navy-600 rounded-lg p-8">
              <h3 className="text-lg font-semibold text-white mb-6">Verification Links</h3>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <header className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Continuous learning and skill development through advanced training programs 
                and specialized courses to stay ahead of evolving cybersecurity challenges.
              </p>
            </header>
            ...
            {/* Training History */}
            <div>
              <h3 className="text-lg font-semibold text-white mb-6">Recent Training</h3>
                ...
                {TRAINING_HISTORY.map((training) => (
                  ...
                  >
                    <header className="mb-4">
                      ...
                      <p className="text-neon-green-400 font-medium">{training.provider}</p>
                    </header>
            ...
            <div className="bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-8 md:p-12 text-center">
              <header className="mb-8">
                ...
                <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                  My comprehensive certifications and continuous professional development ensure 
                  that I bring the highest level of expertise to every cybersecurity project 
                  and consultation.
                </p>
              </header>
