      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <motion.div variants={itemVariants} className='space-y-6'>
            ...
            <p className='text-lg text-gray-400 leading-relaxed mb-8'>
              Bridging Security and Innovation. With 1+ years of professional
              cybersecurity experience, I combine security expertise with
              full-stack development to create secure, innovative solutions for
              startups and SMBs. Passionate about making complex security
              concepts accessible and implementing proactive security measures.
            </p>
        ...
        >
          <motion.div variants={itemVariants} className='text-center mb-16'>
            ...
            <h2 className='text-4xl lg:text-5xl font-bold text-white mb-6'>
              Cybersecurity & <span className='text-cyan-400'>Development</span>{' '}
              Expertise
            </h2>
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Specializing in proactive security measures and secure development
              practices. My dual expertise allows me to build security into the
          ...
          <motion.div variants={itemVariants} className='mb-12'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {SKILLS.filter(skill => skill.category === 'cybersecurity').map(
                skill => (
                  <Card
                    key={skill.id}
          ...
          <motion.div variants={itemVariants} className='mb-12'>
            ...
            <div className='grid md:grid-cols-2 gap-6'>
              {SKILLS.filter(skill => skill.category === 'development').map(
                skill => (
                  <Card
                    key={skill.id}
        ...
        >
          <motion.div variants={itemVariants} className='text-center mb-16'>
            ...
            <h2 className='text-4xl lg:text-5xl font-bold text-white mb-6'>
              Credentials &{' '}
              <span className='text-neon-green-400'>Experience</span>
            </h2>
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              1+ Years of Professional Cybersecurity Experience with
              comprehensive certifications and proven track record in protecting
              digital assets.
            </p>
          </motion.div>
        ...
        >
          <motion.div variants={itemVariants} className='text-center'>
            ...
            <p className='text-xl text-gray-300 max-w-4xl mx-auto mb-12'>
              Combining cybersecurity expertise with full-stack development to
              deliver comprehensive security solutions that are both technically
              sound and business-focused.
            </p>
        ...
        >
          ...
          <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
            Let's discuss how I can help protect your organization with
            comprehensive cybersecurity solutions and secure development
            practices.
          </p>
