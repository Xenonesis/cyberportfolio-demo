...
export const NewsletterSignup: React.FC<NewsletterSignupProps> = ({
  ...
  if (isSubscribed) {
    return (
      <div
        className={`bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-6 text-center ${className}`}
      >
        ...
        <p className='text-gray-300 text-sm'>
          You've successfully subscribed to our cybersecurity insights
          newsletter.
        </p>
      </div>
    );
  ...
  return (
    <div
      className={`bg-navy-800/80 backdrop-blur-sm border border-cyan-500/30 rounded-2xl p-6 ${className}`}
    >
